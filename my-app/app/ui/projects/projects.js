    ...
    <div className={styles.projects_main}>
      ...
      >
        <SwiperSlide className={styles.projects_slide}>
          <img className={styles.projects_image} src="pics/projects1.jpg" alt="project1" />
        ...
        <SwiperSlide className={styles.projects_slide}>
          <img className={styles.projects_image} src="pics/project2.jpg" alt="project2" />
          <div className={styles.projects_legend}>
        ...
        <SwiperSlide className={styles.projects_slide}>
          <img className={styles.projects_image} src="pics/projects1.jpg" alt="project3" />
          <div className={styles.projects_legend}>
        ...
        <SwiperSlide className={styles.projects_slide}>
          <img className={styles.projects_image} src="pics/project2.jpg" alt="project4" />
          <div className={styles.projects_legend}>
        ...
        <SwiperSlide className={styles.projects_slide}>
          <img className={styles.projects_image} src="pics/projects1.jpg" alt="project5" />
          <div className={styles.projects_legend}>
        ...
        <SwiperSlide className={styles.projects_slide}>
          <img className={styles.projects_image} src="pics/project2.jpg" alt="project6" />
          <div className={styles.projects_legend}>
